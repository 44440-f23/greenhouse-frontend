...
class Database:
    ...
    def select_current_configs(self):
        ...
        with self.app.app_context():
            ...
            # loop through rows of returned info and store them in there
            # correct spot in the json object
            current_gh = 0
